...
public class StaticLoggerBinderTests
{
    ...
    {
        assertSame(TestLoggerFactory.getInstance(), StaticLoggerBinder
    ...
    {
        assertEquals("uk.org.lidalia.slf4jtest.TestLoggerFactory",
    ...
    public void getLoggerFactoryReturnsCorrectlyFromSlf4JLoggerFactory()
    {
        ...
        assertEquals(expected, LoggerFactory.getILoggerFactory());
    }
